...
import { _MinimumAdultsPassenger, _MinimumChildrenPassenger, _MinimumHotelRoom } from '~constants/globalConstants';
import { _MaxPriceRange, _MinPriceRange } from '~constants/hotelConstants';
